describe('NAP CA Timing update ',()=>{
    it('Footer Timing',()=>{
 cy.visit('https://newageproducts.com/ca')

//cy.get('.MuiInputBase-input').eq(1).type('a1a1a1');

//cy.get('.sc-cdf11386-8').click();
cy.wait(3000)
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(3) > .bold').should('have.text', 'Sales Team');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(3) > :nth-child(2)').should('have.text', 'Mon-Fri: 9AM - 7PM EST');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(3) > :nth-child(3)').should('have.text', 'Sat-Sun: 9:30AM - 5PM EST');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(4) > .bold').should('have.text', 'Customer Service Team');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(4) > :nth-child(2)').should('have.text', 'Mon-Fri: 9AM - 7PM EST');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(5) > .bold').should('have.text', 'Live Product Demos');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(5) > :nth-child(2)').should('have.text', 'Mon-Fri: 9AM - 7PM EST');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(5) > :nth-child(3)').should('have.text', 'Sat-Sun: 9:30AM - 5PM EST');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(6) > .bold').should('have.text', 'Experience Center Hours');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(6) > :nth-child(2)').should('have.text', 'Mon-Fri: 11AM - 5PM EST');
cy.get('.sc-47305ea1-1 > :nth-child(6) > :nth-child(6) > :nth-child(3)').should('have.text', 'Sat-Sun: 10AM - 5PM EST');


})

it('About US page Timing',()=>{
    cy.visit('https://newageproducts.com/ca/about-us/')
    cy.wait(3000)
    ...
    it('Experience Center page timing',()=>{
        cy.visit('https://newageproducts.com/ca/experiencecenter/')
        cy.wait(3000)
        cy.get('.info > :nth-child(1) > :nth-child(1)').should('have.text', 'Experience Centre');
        cy.get(':nth-child(1) > .no-bold').should('have.text', '1190 Caledonia Rd, Toronto, Ontario, M6A 2W5');
        cy.get('.info > :nth-child(2) > :nth-child(1)').should('have.text', 'Business Hours');
        ...
        it('Contact US page Timing',()=>{
            cy.visit('https://newageproducts.com/ca/contact-us/')
            cy.wait(3000)
            ...
            it('Newsroom page timing',()=>{
                cy.visit('https://newageproducts.com/ca/newsroom/')
            cy.wait(3000)
            ...
            cy.get('.info > :nth-child(5) > :nth-child(1)').should('have.text', 'Experience Centre Hours');
            ...
            it('Live product page timing',()=>{
                cy.visit('https://newageproducts.com/ca/live-product-demo/')
                cy.wait(3000)
